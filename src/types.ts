...
export class Types {
  private readonly options: Required<TypesOptions>;
  ...
  async process(input: unknown): Promise<Record<string, unknown>> {
    ...
    return { status: "success", module: "Types", result };
  }
  ...
  getStatus(): Record<string, unknown> {
    return { module: "Types", initialized: this.initialized, dataKeys: [...this.data.keys()] };
  }
